...
The NVIDIA License limits use of the covered code and derivative works to non-commercial research and educational purposes. The current PartSAM inference pipeline imports and uses these components, so use of the complete pipeline must comply with those terms.

## Other third-party code

Third-party code remains subject to its original license and copyright notices. Nothing in the PartSAM MIT License overrides the license terms of third-party components.
